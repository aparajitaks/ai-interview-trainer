        ...
        <div className="bg-gray-800 p-6 rounded-xl">
          ...
          <form onSubmit={submit} className="space-y-4">
            <div>
              ...
              <input value={username} onChange={(e) => setUsername(e.target.value)} className="w-full mt-1 p-2 rounded bg-gray-900 text-white border border-gray-700" />
            </div>
            <div>
            ...
            <div>
              <button type="submit" className="w-full py-2 rounded bg-indigo-600">Create account</button>
            </div>
          </form>
        </div>
      </div>
